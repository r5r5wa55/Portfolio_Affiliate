...
export default function Project() {
  return (
    <div>
        ...
        <h2 className='font-bold text-2xl mb-5'>Future</h2>
        <h1 className='xl:text-6xl md:text-6xl sm:text-6xl font-bold text-blue-400 m-0 flex text-3xl'>แนวคิด<div className="mx-5 text-red-400">&</div> ทัศนวิสัย</h1>
        </div>
